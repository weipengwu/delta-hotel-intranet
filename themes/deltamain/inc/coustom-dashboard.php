...
jQuery(document).ready( function($) 
{
	...
	<div class="welcome-panel-column">
		...
		<?php elseif ( 'page' == get_option( 'show_on_front' ) ) : ?>
			<li><?php printf( '<a href="%s" class="welcome-icon welcome-edit-page">' . __( 'Edit your default page' ) . '</a>', admin_url('options-reading.php') ); ?></li>
			<li><?php printf( '<a href="%s" class="welcome-icon welcome-add-page">' . __( 'Add additional pages' ) . '</a>', admin_url( 'post-new.php?post_type=page' ) ); ?></li>
		...
		<?php else : ?>
			...
			<li><?php printf( '<a href="%s" class="welcome-icon welcome-edit-page">' . __( 'Edit your default page' ) . '</a>', get_edit_post_link( get_option( 'page_on_front' ) ) ); ?></li>
	...
	<div class="welcome-panel-column welcome-panel-last">
		...
		<ul>
			...
			<li><?php printf( '<a href="%s" class="welcome-icon welcome-write-blog">' . __( 'Add a Headline' ) . '</a>', admin_url( 'post-new.php' ) ); ?></li>
