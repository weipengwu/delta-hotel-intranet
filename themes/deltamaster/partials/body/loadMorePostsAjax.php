...
$numPosts = (isset($_GET['perpage'])) ? $_GET['perpage'] : 6;
...
<div class="feed row">
    ...
    <? endif; ?>
        ...
        <p><?php the_excerpt(); ?></p>
        <small>Posted <?php the_date(); ?>, <?php the_time() ?> by <?php the_author(); ?> in <a href="<?php bloginfo('url'); ?>"><?php bloginfo('name'); ?></a></small>
    </div>
