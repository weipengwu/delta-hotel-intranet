    ...
    <div class="slider slider-for">
        ...
        <!---->
            ...
            <div class="item">
                            ...
                            <h4><?php echo $image_link->post_content; ?></h4><a href="#"><? _e('Learn more','deltamain')?> &gt;</a>
                        </div>
            <?php 
...
function the_network_posts(){
    ...
    foreach($r_posts as $posts){
            ...
            $ThemeExcerpt = extractExcerpt($excerpt);// mb_substr( wp_strip_all_tags( $excerpt ),0,150);
            ...
            $html.='<img src="'. $posts->thumbnail .'" alt="post image"/>';
             ...
             $html.='</a></div>';
                ...
                $html.='<div class="columns large-3">
                    ...
                    '. getPostLikeLink( get_the_ID() ) .'</div></div>'; 
    }
