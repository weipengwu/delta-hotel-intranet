...
<div class="item clearfix">
						...
						<div class="postComment clearfix">
							<?php $args = array(
							  'id_form'           => 'commentform',
							  'id_submit'         => 'submit',
							  'title_reply'       => __( '<p><strong>Add your comment to the discussion</strong></p><p>Before commenting, please refer to the <strong>Delta Discussion Guide</strong> and <strong>Code of Ethics</strong>.  Always be respectful of your colleagues.</p>' ),
